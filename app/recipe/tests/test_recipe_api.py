...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_recipe(self):
        ...
        the_recipe = Recipe.objects.get(id=res.data['id'])
        for k, v in payload.items():
            self.assertEqual(getattr(the_recipe, k), v)
        self.assertEqual(the_recipe.user, self.user)
    ...
    def test_partial_update(self):
        ...
        self.assertEqual(new_recipe.title, payload['title'])
        self.assertEqual(new_recipe.link, original_link)
        self.assertEqual(new_recipe.user, self.user)

    def test_full_update(self):
        """Test full update of a recipe."""
        original_link = "https://example.com/recipe.pdf"
        recepie: Recipe = create_recipe(
            user=self.user,
            title='Sample recipe title',
            link=original_link,
        ...
        for fieldName, fieldValue in payload.items():
            self.assertEqual(getattr(recepie, fieldName), fieldValue)
